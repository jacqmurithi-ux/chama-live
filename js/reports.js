...
layout.js is the sole page bootloader for this page.
...
return `     <span class="status-badge ${statusClass(status)}">
...
methods
.map(method => `           <option value="${escapeHtml(method)}">
...
if (!map.size) {
target.innerHTML = `       <tr>         <td colspan="3" class="report-empty">
          No data.         </td>       </tr>
    `;
...
target.innerHTML =
[...map.entries()]
.map(([type, value]) => `         <tr>           <td>
            ${escapeHtml(
              contributionTypeLabel(type)
            )}           </td>           <td>
            ${value.count}           </td>           <td class="amount">
            ${money(value.amount)}           </td>         </tr>
      `)
.join("");
}
...
target.innerHTML =
[...map.entries()]
.map(([category, value]) => `         <tr>           <td>
            ${escapeHtml(category)}           </td>           <td>
            ${value.count}           </td>           <td class="amount">
            ${money(value.amount)}           </td>         </tr>
      `)
.join("");
...
if (!rows.length) {
target.innerHTML = `       <tr>         <td colspan="6" class="report-empty">
          No data.         </td>       </tr>
    `;
...
if (!rows.length) {
target.innerHTML = `       <tr>         <td colspan="5" class="report-empty">
          No data.         </td>       </tr>
    `;
...
if (target) {
if (!rows.length) {
target.innerHTML = `         <tr>           <td colspan="4" class="report-empty">
            No meetings.           </td>         </tr>
      `;
} else {
target.innerHTML =
...
output.innerHTML = ` <div class="report-kpi-grid">
...
layout.js calls this exported initializer.
========================================================= */
