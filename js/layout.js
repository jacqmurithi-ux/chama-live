...
function injectMobileNavigationStyles() {
  ...
  style.textContent = `
    ...
    @media (max-width: 650px) {
      ...
      .mobile-nav-main.active .mobile-nav-icon {
        background: #115e59;
      }
...
async function initLayout() {
  ...
  /*
   * 1. Inject mobile navigation CSS
   */
  ...
  /*
   * 6. Load the current page JavaScript
   */
